          ...
          <div className="relative flex flex-col items-center justify-center">
            ...
            <div className="bg-main-bg-color text-color p-3 shadow-lg rounded-lg mt-2 md:mt-3 max-w-4xl mx-auto border-2 border-paragraph md:p-5">
              <p className="text-white text-xs leading-snug sm:text-sm md:text-lg lg:text-md lg:leading-normal xl:leading-loose">
                Hello! My name is Jean-Baptiste, and I have created this Ebook
                to help you achieve your ideal weight year-round. Inside,
                you&apos;ll find valuable data, graphics, and tools to support
                you in reaching your goals. I hope this resource proves
                invaluable on your journey toward a better version of yourself!
              </p>
            </div>
